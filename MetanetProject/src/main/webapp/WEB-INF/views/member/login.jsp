   ...
   <div class="back">
      <div class="infoBox" style="width: 506px; height: 698px; margin-left:60%">
         ...
         <form action="write" method="post">
            <input class="userInput" id="login_id" type="text" style="width:432; height:65; left:37; top:210" placeholder="계정 ID">
            <input class="userInput" id="login_pwd" type="password" style="width:432; height:65; left:37; top:306" placeholder="비밀번호">
            ...
            <input class="blueButton" id="login_btn" type="submit" value="로그인" style="width:432; height:76; left:37; top:439">
         </form>
